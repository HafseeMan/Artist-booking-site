...
class Venue(db.Model):
    ...
    past_shows = db.relationship("Show", backref="venues", lazy=False, cascade="all, delete-orphan")
    upcoming_shows = db.Column(db.String, nullable=False, default=False)
...
#    artist_image_link = db.Column(db.String, db.ForeignKey("Artist.image_link"), nullable=False)
